...
import { isNativePlatform, getWebOrigin } from "./platform";
import { resolvePasswordResetRedirect } from "./authRedirect";
...
export function useAuth() {
  ...
  const requestPasswordReset = useCallback(async (email) => {
    ...
    const { redirectTo, error: redirectError } = resolvePasswordResetRedirect({
